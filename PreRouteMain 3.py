...
# PRINT MAIN MENU
        ...
        print("Press 0 to fetch the list of calendars.")
...
# MAIN INPUT 0: FETCH AND PRINT LIST OF CALENDARS
# CRUCIAL: Has no page-change functionality. You are only seeing the first page of calendars.
        print("Okay, getting calender list now.")
        ...
        try:
            ...
            print("Probably a problem with indexes.")

# MAIN INPUT 1: DOWNLOAD AND PRINT CALENDAR.
            ...
            try:
                ...
                for event in events:
                    try:
                        ...
                        print("HEY LOOK HERE: THIS IS THE DATA TYPE OF EVENTS", type(events))
                        next_event = events[events.index(event) + 1]
                        print("Lets see if next event works:", print(next_event))
